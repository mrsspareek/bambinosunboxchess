...
export default function HomePage() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8 bg-slate-50">
      {/* Hero Section */}
        ...
        <div className="lg:col-span-5 space-y-6 text-center lg:text-left">
          <div className="space-y-2">
            ...
            <p className="text-slate-500 font-medium text-base">
              Join students & grandmasters worldwide. Play real-time 2 player matches, challenge friends, solve tactical puzzles, and master Unbox Chess.
            </p>
          </div>
